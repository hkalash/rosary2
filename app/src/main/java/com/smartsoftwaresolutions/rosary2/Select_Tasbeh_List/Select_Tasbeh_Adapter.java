...
public class Select_Tasbeh_Adapter extends ArrayAdapter<Tasbeh_info> {
...
public Select_Tasbeh_Adapter(List<Tasbeh_info> UnitList, Context ctx) {
...
// we creat a view holder
        ...
        v = inflater.inflate(R.layout.select_tasbeh_element, null);
        // Now we can fill the layout with the right values
        TextView unit_Id = v.findViewById(R.id.tv_Id_Pay1);
        TextView Unit_name = v.findViewById(R.id.tv_name_Pay1);
        TextView tv_tasbeh_native = v.findViewById(R.id.tv_tasbeh_native1);
        TextView tv_tasbeh_counter = v.findViewById(R.id.tv_tasbeh_counter1);
