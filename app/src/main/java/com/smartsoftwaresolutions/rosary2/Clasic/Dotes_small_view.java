...
public class Dotes_small_view extends View {
    // count of the dots
    private static final int DOTS_COUNT = 14;
    // position of dots
...
// color of dotes
    ...
    public Dotes_small_view(Context context) {
        super(context);
        init();
    }public Dotes_small_view(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public Dotes_small_view(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public Dotes_small_view(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public static final Property<Dotes_small_view, Float> DOTS_PROGRESS = new Property<Dotes_small_view, Float>(Float.class, "dotsProgress") {
        @Override
        public Float get(Dotes_small_view object) {
            return object.getCurrentProgress();
        }

        @Override
        public void set(Dotes_small_view object, Float value) {
