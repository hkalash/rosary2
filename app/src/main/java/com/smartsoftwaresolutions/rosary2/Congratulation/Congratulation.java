package com.smartsoftwaresolutions.rosary2.Congratulation;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_setting:
                Intent intent=new Intent(Congratulation.this, Setting.class);
                startActivity(intent);

                return true;
            case R.id.action_Help:
                Intent intent2=new Intent(Congratulation.this, Help_Activity.class);
